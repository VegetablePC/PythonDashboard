...
fig1.update_layout(title_text="Claims During Stormy Weather", title_x=0.3) # Titles the graph and moves the title closer to center
...
fig2.update_layout(title_text="Claims During Clear Weather", title_x=0.3) # Titles the graph and moves the title closer to center
