...
fig1.update_layout(title_text="Claims During Stormy Weather", title_x=0.35) # Titles the graph and moves the title closer to center
...
fig2.update_layout(title_text="Claims During Clear Weather", title_x=0.35) # Titles the graph and moves the title closer to center
...
st.markdown("<h1 style='text-align: center; color: grey; '>Description</h1>", unsafe_allow_html=True)
st.write(desc.read())
